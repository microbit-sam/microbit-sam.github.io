...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        (function (BrowserImpl) {
            ...
            function sha256block(buf) {
                var hs = new Uint32Array(8);
                hs[0] = 0x6a09e667;
                hs[1] = 0xbb67ae85;
                hs[2] = 0x3c6ef372;
                hs[3] = 0xa54ff53a;
                ...
                var chunkLen = 16 * 4;
                pxtc.Util.assert(buf.length % chunkLen == 0);
                for (var i = 0; i < buf.length; i += chunkLen) {
                    for (var j = 0; j < 16; j++) {
                        var off = (j << 2) + i;
            ...
            BrowserImpl.sha256block = sha256block;
...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        var booleanAttributes = ["advanced", "afterOnStart"];
