...
(function (pxt) {
    ...
    (function (winrt) {
        ...
        function saveOnlyAsync(res) {
            ...
            savePicker.fileTypeChoices.insert(pxt.Util.lf("MakeCode binary file"), fileTypes);
    ...
    (function (winrt) {
        var WindowsRuntimeIO = (function () {
            ...
            WindowsRuntimeIO.prototype.initAsync = function () {
                ...
                if (!WindowsRuntimeIO.hidSelectors) {
                    this.initHidSelectors();
                }
                var getDevicesPromise = WindowsRuntimeIO.hidSelectors.reduce(function (soFar, currentSelector) {
            ...
            WindowsRuntimeIO.prototype.initHidSelectors = function () {
                var whid = Windows.Devices.HumanInterfaceDevice.HidDevice;
                WindowsRuntimeIO.hidSelectors = [];
                if (pxt.appTarget && pxt.appTarget.compile && pxt.appTarget.compile.hidSelectors) {
                    pxt.appTarget.compile.hidSelectors.forEach(function (s) {
                        ...
                        WindowsRuntimeIO.hidSelectors.push(sel);
                    });
                }
            };
